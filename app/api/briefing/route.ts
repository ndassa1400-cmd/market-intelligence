...
Today is ${today}. Search for and analyze:
...
For each theme in prior briefings, explicitly note whether today's data STRENGTHENS, HOLDS, or WEAKENS the thesis. Reference specific prior predictions and whether they proved correct.
...
Be thorough and analytically rigorous. Generate at least 8 news cards, 5-6 movers, and 5-6 theses.`
    ...
    const message = await client.messages.create({
      ...
      messages: [
        {
          role: 'user',
          content: 'Generate today market briefing now.',
        },
      ],
      system: systemPrompt,
    })
